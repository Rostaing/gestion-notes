...
class EnsClasMatieresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ens_clas_matiere" do
    assert_difference('EnsClasMatiere.count') do
      post ens_clas_matieres_url, params: { ens_clas_matiere: { anneeacademique_id: @ens_clas_matiere.anneeacademique_id, cla_id: @ens_clas_matiere.cla_id, matiere_id: @ens_clas_matiere.matiere_id, user_id: @ens_clas_matiere.user_id } }, as: :json
    end
  ...
  test "should update ens_clas_matiere" do
    patch ens_clas_matiere_url(@ens_clas_matiere), params: { ens_clas_matiere: { anneeacademique_id: @ens_clas_matiere.anneeacademique_id, cla_id: @ens_clas_matiere.cla_id, matiere_id: @ens_clas_matiere.matiere_id, user_id: @ens_clas_matiere.user_id } }, as: :json
    assert_response 200
  end
